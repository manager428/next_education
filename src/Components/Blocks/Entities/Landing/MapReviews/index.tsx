...
import {
  ...
  Title,
  UserReview,
} from 'Components/Blocks/Entities/Landing/MapReviews/styles'
...
const MapReviews: React.FC<Props> = ({ data }) => {
  ...
  return (
    <Container justifyContent="center" pb={80} pt={60}>
      <Flex flexWrap="wrap" maxWidth={720} width={1}>
        <Title>
          Become a part of the <span>world’s largest</span> educational
          ecosystem
        </Title>
