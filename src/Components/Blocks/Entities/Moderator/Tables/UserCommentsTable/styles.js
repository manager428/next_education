...
import {
  tableBanGlyph,
  tableBlockGlyph,
  tableCommentDeleteGlyph,
  tableCommentEditGlyph,
  tableWarningGlyph,
  userBookmarkGlyph,
...
export const BanIcon = styled(Icon).attrs(props => ({
  icon: tableBanGlyph,
  size: 26,
  fill: !props.active ? '#BDBDBD' : '#FFA08C',
  stroke: !props.active ? '#BDBDBD' : '#FFA08C',
}))``

export const BlockIcon = styled(Icon).attrs(props => ({
  icon: tableBlockGlyph,
  size: 26,
  fill: !props.active ? '#BDBDBD' : '#EB5757',
  stroke: !props.active ? '#BDBDBD' : '#EB5757',
}))``

export const DeleteCommentIcon = styled(Icon).attrs({
  icon: tableCommentDeleteGlyph,
  size: 26,
})``

export const EditCommentIcon = styled(Icon).attrs({
  icon: tableCommentEditGlyph,
  size: 26,
  // fill: '#49CEB1',
  // stroke: '#49CEB1',
})``
