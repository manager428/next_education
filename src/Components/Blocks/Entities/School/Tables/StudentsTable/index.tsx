...
import { useColumns } from 'Components/Blocks/Entities/School/Tables/StudentsTable/columns'
import {
  Container,
  Content,
} from 'Components/Blocks/Entities/School/Tables/StudentsTable/styles'

import { ISchoolStudentsResponse } from 'Services/Api/requests/school/interfaces'

type Props = {
  data: ISchoolStudentsResponse
  isLoading: boolean
