...
import { TableLink } from 'Components/Blocks/Entities/School/Tables/TeacherClassroomsTable/styles'
...
const StudentsCell: React.FC<{
  ...
  <Flex flexWrap="wrap" justifyContent="center" width={1}>
    ...
    <Flex mt="10px">
      <Link
        href={SCHOOL_PATHS.TEACHER_CLASSROOM(original.teacher.id, original.id)}
        passHref
      >
