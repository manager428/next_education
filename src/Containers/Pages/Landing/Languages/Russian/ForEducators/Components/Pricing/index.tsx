          ...
          <Inner maxWidth={980}>
            ...
            <Flex justifyContent="space-between" mt={40} width={1}>
              <Card maxWidth={300} padding={20}>
                <Flex minHeight="108px" width={1}>
                  <Icon icon={priceBasicGlyph} size={76} />
                  <Flex flexGrow={1} flexWrap="wrap" ml={18}>
                    <Element fontSize="16px" fontWeight={800} width={1}>
                      7-дневный
                      <br />
                      пробный период
                    </Element>
                ...
                <Flex alignSelf="flex-end" justifyContent="center" width={1}>
                  <Link
                    href="https://buy.stripe.com/3cs5n27BC4fTdUY5kC"
                    passHref
                  >
              ...
              <Card maxWidth={300} padding={20}>
                ...
                <Flex alignSelf="flex-end" justifyContent="center" width={1}>
                  <Link
                    href="https://buy.stripe.com/00gcPue0027L3gk8wB"
                    passHref
                  >
                    <ChoosePlanLink rel="noreferrer noopener" target="_blank">
                      <Flex alignItems="center" justifyContent="center">
              ...
              <Card maxWidth={300} padding={20}>
                <Flex minHeight="108px" width={1}>
                  ...
                  <Flex flexGrow={1} flexWrap="wrap" ml={18}>
                    ...
                    <Element fontSize={18} lineHeight="24px" mt="10px">
