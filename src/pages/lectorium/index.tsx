...
import { ogLectoriumImage } from 'Assets/images/og'
...
export const Lectorium: NextPage<Props> = ({ initialData }) => {
  ...
  return (
    <Background>
      <Head
        description="The library of video content on 21st-century skills, global citizenship, and social-emotional skills that can be used in the classroom. Educators can add assessments to check how students understand the material and get analytics about students' work."
        ogImage={ogLectoriumImage.src}
        title="Lectorium - Global content for curriculum | iDialogue"
      />
      <Container>
        ...
        {isShowDefaultPosts && <Slider data={slider} />}
